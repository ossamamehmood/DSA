...
class Binary {
	...
	void findTerminal(node ptr, node parent) {
        // node terminal = null;
        if(root==null) {
        ...
        if(ptr!=null) {
			...
			// 	// terminal = root;
			// 	System.out.println("Terminal:" + ptr.info);
			// 	casea(null, ptr);
			// 	return;
			// } else
			if (ptr.lchild == null && ptr.rchild == null){ // if terminal then delete
                // terminal = ptr;
                // System.out.println("Terminal: " + terminal.info);
                casea(parent, ptr);
                return;
            }
            findTerminal(ptr.lchild, ptr);
            // System.out.println(ptr.info);
            findTerminal(ptr.rchild, ptr);
        }
    }
...
public class Q3 {
		...
		while(true)	{
			...
			System.out.println("6. Find and delete Terminal");
